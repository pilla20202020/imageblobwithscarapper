...
Route::group(['middleware' => 'auth','namespace' => 'App\Http\Controllers'], function () {
    ...
    */
    ...
    Route::group(['as' => 'user.', 'prefix' => 'user',], function () {
        ...
        Route::post('detail', 'User\UserController@detail')->name('detail');
    ...
    */
    ...
    Route::group(['as' => 'image.', 'prefix' => 'image',], function () {
        Route::get('', 'Image\ImageController@index')->name('index')->middleware('permission:role-index');
        Route::get('create', 'Image\ImageController@create')->name('create')->middleware('permission:permission-create');
        Route::post('', 'Image\ImageController@store')->name('store')->middleware('permission:role-store');
        Route::get('{image}/edit', 'Image\ImageController@edit')->name('edit')->middleware('permission:permission-edit');
        Route::put('{image}', 'Image\ImageController@update')->name('update')->middleware('permission:role-update');
        Route::get('image/{id}/destroy', 'Image\ImageController@destroy')->name('destroy')->middleware('permission:permission-delete');
        Route::get('store_image/fetch_image/{id}', 'Image\ImageController@fetchImage');
        Route::get('scapper', 'Image\ImageController@scraper');
    });
